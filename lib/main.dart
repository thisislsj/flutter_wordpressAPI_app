...
import 'package:flutter_wordpressapi_app/constant/app_constant.dart';
...
void main() {
  runApp(MaterialApp(home: WordPressHome()));
}
...
class WordPressHomeState extends State<WordPressHome> {
  ...
  Future<String> getPosts() async {
    var res = await http.get(Uri.encodeFull(API_URL_BASE + "posts?_embed"),
